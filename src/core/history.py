...
class HistoryManager:
    """Gestiona el historial de cálculos con persistencia en JSON."""
    ...
    def search(self, query: str) -> List[CalculationRecord]:
        ...
        return [
            ...
            if query_lower in r.expression.lower()
            or query_lower in r.result.lower()
        ]
    ...
    def export_to_text(self, file_path: Optional[str] = None) -> str:
        ...
        lines = [
            "=" * 60,
            "HISTORIAL DE CALCULADORA CIENTÍFICA",
